# Самостоятельные учебные работы по теме "Обработка естественного языка"
...
### [Ссылка на ноутбук в GoogleColab](https://colab.research.google.com/drive/1HUHtozC5CUjTLV--_lcXHEfYYp3Jn2xi?usp=sharing)
---
###  Задание: Скрытая марковская модель
1. Скачайте текст произведения «Война и мир». Очистите его, оставив только русские буквы и символы пробела.
2. Постройте матрицу переходных вероятностей.
3. Посчитайте вероятность встретить строку из четырёх символов, которая начинается на букву «П» и заканчивается на букву «Р».
4. Используя матрицу переходных вероятностей, сгенерируйте слово, начинающееся с буквы «Б» длиной восемь символов.
5. Выберите ряд из предыдущих домашних заданий по временным рядам и оцените его через HMM.
6. Попробуйте построить через среднее каждой компоненты наивный прогноз ряда.
### [Ссылка на ноутбук в GoogleColab](https://colab.research.google.com/drive/1n2FFQ4MfVGELhsSCrZ-hN0ObSqbiqHg1?usp=sharing)
---
